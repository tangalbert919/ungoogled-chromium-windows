...
async function run() {
    ...
    if (from_artifact) {
        ...
        await artifactClient.downloadArtifact(artifact.artifact.id, 'C:\\ungoogled-chromium-windows\\build');
        await exec.exec('7z', ['x', 'C:\\ungoogled-chromium-windows\\build\\' + artifact.artifact.id.toString() + '.zip',
